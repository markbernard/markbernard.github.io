...
<pre><code class="java">private void createToolbar() {
    ...
    <p>As you can see this is very similar to creating menus. You first create the javax.swing.JToolBar and it to your container. After that you just add each Action that represents the options you want the user to have access to. You can also use the addSeparator() method to provide some visual separation so you can categorize your options.</p>
    <p>The JToolBar class has built in functionality to allow the user to drag it out of its default location and have it float over the application. The user can also drag it back to the application and dock it in one of the four sides of the application. If you wish to prevent the user from doing this you can just call the setFloatable(boolean b) method passing in false to turn off the floating toolbar. If you want to have the full functionality of this feature you need to make sure the container that holds the toolbar has its layout manager set to BorderLayout and all four borders are empty. You also need to place the toolbar in one of those borders.</p>
    <div class="row">
        <div class="col-md-8">
            <figure>
...
<div class="panel-footer foot-nav">
    <div class="row">
        <div class="col-md-4 col-sm-1"><a href="/startingswing/page.php?page=chap6">View &amp; Help Menu</a></div>
        <div class="col-md-4 col-sm-1 text-center"><a href="/startingswing/page.php?page=contents">Contents</a></div>
        <div class="col-md-4 col-sm-1"><span class="pull-right"><a href="/startingswing/page.php?page=chap8">Multiple Tabs &amp; Recent Documents</a></span></div>
    </div>
</div>
